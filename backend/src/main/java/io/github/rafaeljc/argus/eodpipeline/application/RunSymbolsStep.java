...
public class RunSymbolsStep {
    ...
    // to record it. @Transactional here (rather than on a facade) because RunAllSteps —
    // this class's only caller — is invoked directly by infrastructure (ExecutorRunDispatcher),
