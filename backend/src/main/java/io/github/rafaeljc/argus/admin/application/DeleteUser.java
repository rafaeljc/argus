...
public class DeleteUser {
    ...
    public DeleteUser(UserLifecycle userLifecycle, AuditLogRepository auditLogRepository, Clock clock) {
        this.userLifecycle = userLifecycle;
        this.auditLogRepository = auditLogRepository;
        this.clock = clock;
    }

    public User delete(UserId targetId, UserId actorId, String reason) {
        UserStateChange change = userLifecycle.softDelete(targetId);
        if (change.changed()) {
