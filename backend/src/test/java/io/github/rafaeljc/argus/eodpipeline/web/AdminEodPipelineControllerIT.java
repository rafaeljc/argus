...
@Import({PostgresContainer.class, RedisContainer.class, AdminEodPipelineControllerIT.TestStubsConfig.class})
...
class AdminEodPipelineControllerIT {
    ...
    void postRuns_validRequest_writesEodRunAuditRow() throws Exception {
        TestSession admin = testLogin.login("admin-audit1@example.com", true);
        ...
        Map<String, Object> row = jdbc.queryForMap(
                "SELECT * FROM admin_audit_log WHERE action = 'EOD_RUN' AND actor_id = ?", admin.userId().value());
    ...
    void postStep_prices_writesEodStepRerunAuditRow() throws Exception {
        TestSession admin = testLogin.login("admin-audit2@example.com", true);
    ...
    void postRuns_validRequest_returns201WithLocationAndEnvelope() throws Exception {
        TestSession admin = testLogin.login("admin@example.com", true);
    ...
    void getRuns_multiplePages_slicesAndOrdersByStartedAtDescending() throws Exception {
        TestSession admin = testLogin.login("admin5@example.com", true);
    ...
    void getRun_existingId_returns200WithRunFields() throws Exception {
        TestSession admin = testLogin.login("admin6@example.com", true);
    ...
    void getRun_unknownId_returns404() throws Exception {
        TestSession admin = testLogin.login("admin7@example.com", true);
    ...
    void postStep_prices_returns200AndResetsPricesAndEvaluateAndDispatchesFromPrices() throws Exception {
        TestSession admin = testLogin.login("admin8@example.com", true);
    ...
    void postStep_namedStepAlreadyInProgress_returns409Conflict() throws Exception {
        TestSession admin = testLogin.login("admin9@example.com", true);
    ...
    void postStep_differentStepInProgress_returns409Conflict() throws Exception {
        TestSession admin = testLogin.login("admin10@example.com", true);
    ...
    void postStep_priorStepFailed_returns409Conflict() throws Exception {
        TestSession admin = testLogin.login("admin13@example.com", true);
        LocalDate runDate = LocalDate.of(2026, 7, 5);
        EodPipelineRun saved = runs.insert(failedRun(
    ...
    void postStep_unknownRunId_returns404() throws Exception {
        TestSession admin = testLogin.login("admin11@example.com", true);
    ...
    void postStep_unknownStep_returns404() throws Exception {
        TestSession admin = testLogin.login("admin12@example.com", true);
    ...
    private ResponseEntity<String> postStep(TestSession authenticatedAs, RunId runId, String step) {
        HttpHeaders headers = new HttpHeaders();
