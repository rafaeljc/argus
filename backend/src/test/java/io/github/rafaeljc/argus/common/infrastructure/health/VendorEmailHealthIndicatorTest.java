...
class VendorEmailHealthIndicatorTest {

    private CircuitBreaker breaker;
    private VendorEmailHealthIndicator indicator;

    @BeforeEach
    void setUp() {
        breaker = CircuitBreaker.of("vendor-email", CircuitBreakerConfig.custom()
                .slidingWindowSize(10)
                .minimumNumberOfCalls(5)
                .failureRateThreshold(50)
                .waitDurationInOpenState(Duration.ofSeconds(30))
                .build());
        indicator = new VendorEmailHealthIndicator(breaker);
    }
