...
| NFR-Sec7 | Rate limiting — auth endpoints | Signup ≤ **5 / h / IP**; password reset ≤ **5 / h / IP** (BR-30); login ≤ **10 / 15 min / IP** with exponential backoff | Backs BRD §2.1; targets credential-stuffing and reset-spam abuse specifically. |
